...
export const MapComponent = ({ points }: MapComponentProps) => {
  ...
  const initMap = () => {
    ...
    const newMap = new window.ymaps.Map(mapRef.current, {
      center: points.length > 0 ? [points[0].lon, points[0].lat] : [42.349170, 69.606002],
      zoom: 13,
  ...
  return <div ref={mapRef} className="w-full h-[350px] bg-gray-200 border border-gray-300 rounded-lg" />;
};
